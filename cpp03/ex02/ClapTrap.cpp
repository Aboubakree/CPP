...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/15 10:39:22 by akrid             #+#    #+#             */
/*   Updated: 2025/02/15 15:03:49 by akrid            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::set_att_damage(unsigned int att_dmg)
{
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	if (energy_point > 0)
	{
		...
		hit_point = (hit_point + amount > 100) ? 100 : hit_point + amount;
		energy_point --;
	}
	else
		std::cout << "ClapTrap "<< name << "Not enought energy points.";
